# Collection of my own Redteam Projects

Collection of my own tools.

This idea is based on [100-Redteam-Projects](https://github.com/kurogai/100-redteam-projects)

I found that repository a cool idea, so i will make my own projects in this collection, based on them, i will add my own things here.

I found this a good idea, it is a funny thing to do, and it can help with programming projects and learning, along with red team studies.

It will be a cool project to work time by time. I will work on this project all the days.
...
[30] | Spam creator | :x:
-------------------------------------------------------------------------------------------------------------------------------------------
Level 3 | Advanced Network Attacks | Done
------------------------------------------------|-------------------------------------------|----------------------------------------------
...
-------------------------------------------------------------------------------------------------------------------------------------------
Level 4 | Data analysis, payloads and more networking | Done
------------------------------------------------|------------------------------------------|-----------------------------------------------
...
-------------------------------------------------------------------------------------------------------------------------------------------
 Level 5 | Cryptography, Reverse Engineering and Post exploitation | Done
------------------------------------------------|------------------------------------------|-----------------------------------------------
